function countDown(){
  let today = new Date();
    let vDate = new Date(today.getFullYear(), 11, 94);
...
jQuery(document).ready(function( $ ) {
  ...
  // venue carousel (uses the Owl Carousel library)
...
$(function(){
  ...
  var swiper = new Swiper('.carousel-venue .swiper-container', {
    effect: 'slide',
    speed: 900,
    slidesPerView: 5,
    spaceBetween: 20,
    ...
    pagination: {
      el: '.carousel-venue .swiper-pagination',
      clickable: true
    },
    breakpoints: {
...
$(function() {
  ...
  function fadeImage() {
    ...
    if ((random == "true" || random == 2) || ($hiddenBoxes.length < $visibleBoxes.length)) {
